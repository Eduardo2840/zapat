...
namespace zapat.ML
{
    public partial class ML_ContacZapatillas
    {
        public const string RetrainFilePath =  @"C:\Users\ADMIN\Desktop\Nueva carpeta (3)\zapat\ML\trainingdata\comentarios_zapatillas.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.0417883F,L2Regularization=0.03125F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}))      
